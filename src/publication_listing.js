...
if (typeof cache === 'undefined') { var cache = []; }
if (typeof custom === 'undefined') { var custom = {}; }
...
function change_css(event) {
    ...
    const lookup_css_file = {'css-standard': css_path+'style.css', 'css-min': css_path+'style-condensated.css'};
