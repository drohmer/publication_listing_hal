...
const publication_config = {
    query : ["https://api.archives-ouvertes.fr/search/?q=authIdHal_s:damien-rohmer&fl=publicationDateY_i,submittedDateY_i,submittedDateM_i,submittedDateD_i,title_s,authFullName_s,doiId_s,journalTitle_s,conferenceTitle_s,files_s,docType_s,fileAnnexes_s,halId_s,thumbId_i,issue_s,volume_s,linkExtUrl_s,bookTitle_s&rows=500&fq=publicationDateY_i:[2020 TO *]"] ,
